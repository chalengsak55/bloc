...
function ModeToggle() {
  const { mode, setMode, isSeller } = useUserMode();
      ...
      <div className="flex gap-1 rounded-full bg-white/[0.04] p-1">
        <button
          ...
          className={`flex-1 rounded-full py-2 text-sm font-semibold transition-all ${
            mode === "buyer" ? "bg-white text-black shadow-sm" : "text-zinc-500"
          }`}
        >
          Buyer
        </button>
        <button
          ...
          className={`flex-1 rounded-full py-2 text-sm font-semibold transition-all ${
            mode === "seller" ? "bg-[#7c5ce8] text-white shadow-sm" : "text-zinc-500"
          }`}
        >
          Seller
        </button>
  ...
  return (
    <Link
      ...
      className="block w-full rounded-xl border border-dashed border-[#7c5ce8]/30 py-2.5 text-center text-sm text-[#7c5ce8] transition hover:bg-[#7c5ce8]/5"
    >
