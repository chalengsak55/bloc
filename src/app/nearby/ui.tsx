...
const DEMO_SELLERS: Seller[] = [
  ...
  },
  {
    ...
    display_name: "Nina Singsawan",
    category: "events",
    location_text: "SF Bay Area",
    is_online: true,
    lat: 37.7730,
    lng: -122.4170,
    avatar_url: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&q=80",
    is_ghost: false,
    card_mode: "text",
    card_text: "Available this weekend · Thai & English songs · Birthday · Wedding",
    storefront_theme: "dark_neon",
  },
  {
    id: "demo:chef-marco",
    place_id: "ChIJb_qTsQx8j4ARfZg9waOROwM",
    display_name: "Chef Marco Silva",
    category: "events",
    location_text: "Menlo Park, CA",
    is_online: true,
    lat: 37.7770,
    lng: -122.4220,
    avatar_url: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80",
    is_ghost: false,
    card_mode: "text",
    card_text: "Private Chef · Menlo Park · Dinner parties from $200",
    storefront_theme: "luxury",
  },
];
